...
var url = "".concat("https://276612fa406fbcb2.api-us.cometchat.io/v3", "/data_import/users");
// Function to generate a single fake user
function generateFakeUser() {
    var name = faker_1.faker.person.fullName();
    var uid = faker_1.faker.string.uuid();
    return {
        uid: uid,
        name: name,
        ...
        status: "active",
        role: "user",
        lastActiveAt: faker_1.faker.date.recent().getTime(),
        createdAt: faker_1.faker.date.past().getTime(),
    };
}
var usersArray = Array.from({ length: 1 }, generateFakeUser);
var users = {};
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    console.log("Error importing users:", error_1.response.data);
                    return [3 /*break*/, 3];
